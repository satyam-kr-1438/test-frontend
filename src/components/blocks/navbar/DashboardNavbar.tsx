...
const DashboardNavbar: FC<NavbarProps> = (props) => {
  ...
  const headerContent = (
    <Fragment>
      <div className="navbar-brand w-100">
        <NextLink href="/dashboard/home" title={<img alt="logo" style={{width:"130px",cursor:"pointer"}} src={`/img/${logo}.png`} />} />
      </div>
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
            <li className="nav-item dropdown dropdown-mega">
              {/* <DropdownToggleLink title="Quizzes" className="nav-link dropdown-toggle" /> */}
              <DashboardNavbarLink title="Free Quizzes" className="nav-link" to="/dashboard/home"/>
            </li>
            <li className="nav-item dropdown dropdown-mega">
              {/* <DropdownToggleLink title="Quizzes" className="nav-link dropdown-toggle" /> */}
              <DashboardNavbarLink title="Packages" className="nav-link" to="/dashboard/home"/>
            </li>

            <li className="nav-item dropdown">
                <DashboardNavbarLink title="Passes" className="nav-link" to="/dashboard/passes"/>
            </li>
            <li className="nav-item dropdown">
      ...
      <div className={navOtherClass}>
        <ul className="navbar-nav flex-row align-items-center ms-auto">
          {button && <li className="d-md-block">{button}</li>}
