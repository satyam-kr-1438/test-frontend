...
const CorrectIncorrectSection = ({ result, tab, leaderboard }: any) => {
                    ...
                    <div className="options-distrubtion mt-5">
                        <div className="option-card-cbet">
                            <div className="Correct-cbet-overview d-flex flex-column justify-content-center align-items-center">
                                <div className='d-flex justify-content-center align-items-center'>
                                    <span>{result?.correct_section_id?.filter((x: any) => x == tab)?.length}
                                    </span><p className='ms-2'>Correct</p>
                                </div>
                                <div style={{ width: 80, height: 80, marginTop: "10px" }}>
                                    <CircularProgressbar value={((result?.correct_section_id?.filter((x: any) => x == tab)?.length) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length) * 100} text={`${(((result?.correct_section_id?.filter((x: any) => x == tab)?.length) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length) * 100)?.toFixed(2)}%`} />
                                </div>
                            </div>
                            {/* <div className="ms-3">
                                <p>Correct</p>
                        ...
                        <div className="option-card-cbet wrong-cbet">
                            <div className="wrong-cbet-overview d-flex flex-column justify-content-center align-items-center">
                                <div className='d-flex justify-content-center align-items-center'>
                                    <span>{result?.incorrect_section_id?.filter((x: any) => x == tab)?.length}</span><p className='ms-2'>Incorrect</p>
                                </div>
                                <div style={{ width: 80, height: 80, marginTop: "10px" }}>
                                    <CircularProgressbar value={((result?.incorrect_section_id?.filter((x: any) => x == tab)?.length) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length) * 100} text={`${(((result?.incorrect_section_id?.filter((x: any) => x == tab)?.length) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length) * 100)?.toFixed(2)}%`} />
                                </div>
                            </div>
                        </div>
                        <div className="option-card-cbet Unattempted-cbet">
                            <div className="Unattempted-cbet-overview d-flex flex-column justify-content-center align-items-center">
                                <div className='d-flex justify-content-center align-items-center'>
                                    <span>{result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length - (result?.correct_section_id?.filter((x: any) => x == tab)?.length + result?.incorrect_section_id?.filter((x: any) => x == tab)?.length)}</span><p className='ms-2'>Unattempted</p>
                                </div>

                                <div style={{ width: 80, height: 80, marginTop: "10px" }}>

                                    <CircularProgressbar value={(result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length - (result?.correct_section_id?.filter((x: any) => x == tab)?.length + result?.incorrect_section_id?.filter((x: any) => x == tab)?.length)) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length * 100} text={`${((result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length - (result?.correct_section_id?.filter((x: any) => x == tab)?.length + result?.incorrect_section_id?.filter((x: any) => x == tab)?.length)) / result?.exam?.examsections?.find((item: any) => item?.id == tab)?.questions?.length * 100)?.toFixed(2)}%`} />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default CorrectIncorrectSection
