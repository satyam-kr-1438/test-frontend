...
import { accordionList1, accordionList2 } from 'data/faq';
type PageTypeProps = {
  text?: string;
};
const TesterikaFaq = () => {
  return (
    <>
      <div className="live-test-main section-spacing light-bg-color">
