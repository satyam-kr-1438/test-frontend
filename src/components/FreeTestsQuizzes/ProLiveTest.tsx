        ...
        <div className="width-container">
            <div className="row">
                <div className="col-lg-12">
                 <h3 className='pb-1 '>Popular Pro Live Tests & <span className='theme-color'>Free</span> Quizzes</h3>
                 <p>Attempt 150+ daily Live tests & quizzes and test your all India ranking.<br />
                 Improve your scores and chances of selection in your target exam.</p>
                 <div className='type-of-quiz-category-wise mt-5'>
