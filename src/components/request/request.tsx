...
let API_URL="https://api.testcontrolcenter.com/api/user/user"
let QUIZ_URL="https://api.testcontrolcenter.com/api/quiz/quiz"
let COMMON_URL="https://api.testcontrolcenter.com/api/common"
let QUESTION_URL="https://api.testcontrolcenter.com/api/question"
export const APIURLADMIN="https://api.testcontrolcenter.com/api/conferenceQuiz/web/admin-setting"
export const PACKAGE_URL="https://api.testcontrolcenter.com/api/package/package"
export const BUNDLE_PACKAGE_URL="https://api.testcontrolcenter.com/api/package/bundle"
export const PAYMENT_GATEWAY_CREDENTIALS_API_KEY="https://api.testcontrolcenter.com/api/conferenceQuiz/quiz/payment-gateway"
export const PAYMENT_API_KEY="https://api.testcontrolcenter.com/api/package/payment"
export const EXAM_API_KEY="https://api.testcontrolcenter.com/api/package/exam"
export const DOUBT_URL="https://api.testcontrolcenter.com/api/package/doubt"
export const USER_URL="https://api.testcontrolcenter.com/api/user/user"
