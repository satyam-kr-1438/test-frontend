      ...
      <div className="width-container">
        <div className="row">
          <div className="col-lg-12 mx-auto">
            <h3 className='pb-1 '><span className='theme-color'>690+ </span>Explore all Exams</h3>
              ...
              <div className="tab-content" id="myTabContent">
                <div className="tab-pane fade show active" id="tabone" role="tabpanel" aria-labelledby="home-tab">
                  <div className="category-listed-exam">
                    <div className='category-list-main-category'>
                     <div className="exam-sub-category">
                      <p  className='margin-top-minius'>
                      <span>
                        <img src="/img/websiteimage/exam-10.png" alt="exam-category-img" />
                      </span>
                      </p>
                      <p>SBI PO</p>
                     </div>
                    ...
                    <div className='category-list-main-category'>
                     <div className="exam-sub-category">
                      <p  className='margin-top-minius'>
                      <span>
                        <img src="/img/websiteimage/exam-8.png" alt="exam-category-img" />
                      </span>
                      </p>
                      <p>SBI PO</p>
                     </div>
                    ...
                    <div className='category-list-main-category'>
                     <div className="exam-sub-category">
                      <p  className='margin-top-minius'>
                      <span>
                        <img src="/img/websiteimage/exam-7.png" alt="exam-category-img" />
                      </span>
                      </p>
                      <p>SBI PO</p>
                     </div>
