...
const QuizFilter: FC<any> = ({ subjects, setCategory, setActivePage }) => {
  ...
  return (
    <div className="col-lg-2  my-lg-14 widget" style={{ marginBottom: "70px", }}>
        ...
        <div className="col-lg-12 mt-3 mb-3">
          <div className='exam-category-listed-here'>
            ...
            <ul className="nav nav-tabs display-exam-category" id="myTab" role="tablist">
              ...
              {
                subjects?.length > 0 ? subjects?.slice()?.map((item: any, index: number) => {
                  return <li key={index} className="nav-item" role="presentation" onClick={() => {
                    ...
                    <button
                      className={selectedCategory == item?.subject_name ? "nav-link active" : "nav-link"}
                      id="home-tab"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width='12' height='12' className='me-2'>
                        <path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z" />
