        ...
        <div className="c-bet-right-side-bar">
          ...
          <div className="c-bet-content-part slider-container  ">
            ...
            <section className="wrapper ">
              ...
              <div className="col-lg-12 text-center pb-5 mt-10">
                    <div className="main-title">
                     <h2>Online <span>Test Series</span></h2>
                     </div>
                    </div>
                <div className="row gy-10">
                   
                <Filter class="mt-0" courses={courses} setCategory={setCategory} setActivePage={setActivePage} />
