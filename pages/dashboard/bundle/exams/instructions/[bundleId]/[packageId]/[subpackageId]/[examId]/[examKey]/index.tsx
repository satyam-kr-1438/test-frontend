...
import { checkBundlePackageIsAvailableForUser, checkPackageIsAvailableForUser, getExamDetailWithQuestions } from 'components/request/request'
                                                                ...
                                                                <div className=""  style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                                                                            ...
                                                                            <button className="btn btn-outline-primary btn-sm" onClick={()=>{
                                                                                 if(!agree){
                                                                                    ...
                                                                                    router.push(`/dashboard/bundle/exams/start/${router.query.bundleId}/${router.query.packageId}/${router.query.subpackageId}/${router.query.examId}/${router.query.examKey}`)
                                                                                }
                                                                            }}>Next</button>
                                                                </div>
