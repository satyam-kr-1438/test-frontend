          ...
          {passes?.length > 0 ? buyNowSection ? <main className="content-wrapper">
            ...
            <main className="content-wrapper">
              ...
              <section className="wrapper">
                <div className="cbet-container text-center">
                  <div className="row">
              ...
              <section className="wrapper" style={{ paddingBottom: "100px" }}>
                <div className="cbet-container pb-5 pb-md-5">
                  <div className="row">
                    <div className="col-12">
                      <div className="row">
                          ...
                          <div className={`card my-5 mx-3 py-3 px-2 col-12 mx-auto`}>
                            <table>
                              <tr className="">
                                ...
                                <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pro" ? "#fff2df" : ""}`, borderRadius: "5px 5px 0px 0px", textAlign: "center", marginLeft: "auto" }} onClick={() => {
                                  setSelectedPlanType("Pro")
                                }}>Pass Pro</td>
                                {/* </th> */}
                                {/* <th style={{backgroundColor:`${selectedPlanType=="Pass"?"#FAF0D1":""}`,borderRadius:"5px 5px 0px 0px",textAlign:"center",marginLeft:"auto"}}> */}
                                <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pass" ? "#fff2df" : ""}`, borderRadius: "5px 5px 0px 0px", textAlign: "center", marginLeft: "auto" }} onClick={() => {
                                  setSelectedPlanType("Pass")
                                }}>Pass</td>
                                {/* </th> */}
                              </tr>
                              ...
                              <tbody>
                                    ...
                                    return <tr key={index} onClick={() => {
                                      ...
                                      <td className="table_features_td" style={{ fontSize: "12px" }}>{item}</td>
                                      {
                                        passesFeatures?.find((item2: any) => item2?.name == "Pass Pro")?.features?.find((item3: any, index3: any) => item3?.feature == item)?.feature == item ?
                                          <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pro" ? "#fff2df" : ""}` }} onClick={() => {
                                            setSelectedPlanType("Pro")
...

                                      {
                                        passesFeatures?.find((item2: any) => item2?.name == "Pass")?.features?.find((item3: any, index3: any) => item3?.feature == item)?.feature == item ?
                                          <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pass" ? "#fff2df" : ""}` }} onClick={() => {
                                            setSelectedPlanType("Pass")
                                          }}><span style={{ textAlign: "center", marginBottom: "10px", fontSize: "12px" }}><IoCheckmarkOutline style={{ color: "green", transform: "scale(1.4)" }} /></span></td> :
                                          <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pass" ? "#fff2df" : ""}` }} onClick={() => {
                                            setSelectedPlanType("Pass")
                                ...
                                <tr>
                                  ...
                                  <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pro" ? "#fff2df" : ""}` }}>
                                  ...
                                  <td className="table_features_td text-center" style={{ backgroundColor: `${selectedPlanType == "Pass" ? "#fff2df" : ""}` }}>
                          ...
                          <div className="d-md-none d-sm-none d-none d-lg-block text-center">
                            <button className="btn btn-outline-primary" onClick={() => {
                              if (packages == "undefined" || typeof packages == "undefined" || !packages?.id) {
                                ErrorMessage("Please select Pass or Pass Pro")
                              } else {
...

                          {
                            selectedPlanType == "Pro" && passes?.filter((item: any) => item?.tblpass_type?.name == "Pass Pro")?.map((item2: any, index2: any) => {
                              return <div key={index2} className={`card my-5 mx-3 py-3 px-2 col-12 mx-auto`} style={{ cursor: "pointer" }} onClick={() => {
                                if (premiumPackages?.length > 0 && premiumPackages?.find((itemData: any) => {
                                  if (itemData?.passid) {
                                ...
                                <label>
                                  <div className="pass_detail_container_main">
                                          ...
                                          <div className="">
                                            <span className="" style={{ fontSize: "14px", display: "flex", justifyContent: "flex-start", alignItems: 'center' }}>
                                              <span>{item2?.pass_name}</span>
                                              {
                                                ...
                                                }) && <span style={{ fontSize: "10px", color: "white", background: "green", fontWeight: "bold", marginLeft: "6px", border: "2px dotted green", padding: "1px 2px", borderRadius: "2px" }}>
                                                  Active Pass
                                    ...
                                    <div className="">
                                      <span style={{ fontSize: "20px" }}>{item2?.price_inr} INR </span>
                                      {/* <hr style={{ margin: "1px" }} />
                        ...
                        <div className="d-md-block d-sm-block d-block d-lg-none text-center">
                          <button className="btn btn-outline-primary" onClick={() => {
