...
import { getAllCoursesSubject, getPackages } from 'components/request/request';
...
import ProductCardAuth from 'components/reuseable/product-cards/ProductCardAuth';
                                          ...
                                          <div className="row mx-1 gy-5">
                                              {
                                                  packages?.length>0 ? packages.map((item:any,index:number) => {
                                                    return <Fragment key={index}>
                                                                <ProductCardAuth currency={currency} {...item} packageKey={item?.hash} itemKey={index} className="col-lg-12 col-12" premiumPackages={premiumPackages}/>
                                                          </Fragment>
                                                  }
