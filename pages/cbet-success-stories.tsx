...
import CbetSuccessStoriesMain from 'components/cbetsuccessstorieshome/CbetSuccessStoriesMain';
import CbetExamPassage from 'components/cbetexampassage/CbetExamPassage';

const Cbetsuccessstories = () => {
  return (
    <>
     <section className="c-bet-dashboard">
        ...
        <div className="c-bet-right-side-bar">
          <CbetTopBar />
          <div className="c-bet-content-part  pt-3 pb-15  ">
            <CbetSuccessStoriesMain />
            <CbetExamPassage />
          </div>
        </div>
      </section>
...
export default Cbetsuccessstories